...
b. Define system access authorizations to support separation of duties.}&{P}&{N}&{Principle of least privilege is applied. Some users have access to hosts that is unneeded.} \\ \hline
...
c. third part applications are used} \\ \hline
...
Deny network communications traffic by default, and allow network communications traffic by exception.}&{Y}&{Y}&{Routing ansd whitelisting is quite explicit.} \\ \hline
...
Implement the following types of cryptography to protect the confidentiality of CUI: [Assignment: organization-defined types of cryptography].}&{Y}&{Y}&{Disk encryption OS level and AES128 on the wire.} \\ \hline
...
c. Protect the system security plan from unauthorized disclosure.}&{Y}&{Y}&{a. RTN-030
...
Apply the following systems security engineering principles to the development or modification of the system and system components: [Assignment: organization- defined systems security engineering principles].}&{P}&{Y}& \\ \hline
